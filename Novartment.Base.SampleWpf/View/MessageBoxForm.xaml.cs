...
namespace Novartment.Base.SampleWpf
{
	...
	public partial class MessageBoxForm : DialogWindow, IDialogView<MessageBoxResult>
	{
		...
		public MessageBoxForm (IDialogViewModel<MessageBoxResult> viewModel) : base ()
		{
		...
		public MessageBoxForm (IDialogViewModel<MessageBoxResult> viewModel, Window owner) : base (owner)
		{
			this.DataContext = viewModel;
			ViewModel = viewModel;
			InitializeComponent ();
