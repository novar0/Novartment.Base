...
namespace Novartment.Base.Net.Mime
{
	...
	{
		private static readonly Dictionary<HeaderFieldName, string> _headerTypes = new ()
		{
		...
		private static readonly Dictionary<string, HeaderFieldName> _headerTypeNames = new (StringComparer.OrdinalIgnoreCase)
		{
