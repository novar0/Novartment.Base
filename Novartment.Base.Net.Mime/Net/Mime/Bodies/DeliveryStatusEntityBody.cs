...
namespace Novartment.Base.Net.Mime
{
		...
		IEntityBody
	{
		...
		private void CreateHeader (IAdjustableCollection<HeaderFieldBuilder> fields)
		{
			...
			if (this.MailTransferAgent != null)
			{
				fields.Add (HeaderFieldBuilder.CreateAtomAndUnstructured (
					...
					this.MailTransferAgent.Kind.GetName (), this.MailTransferAgent.Value));
			}
			...
			if (this.ReceivedFromMailTransferAgent != null)
			{
				fields.Add (HeaderFieldBuilder.CreateAtomAndUnstructured (
					...
					this.ReceivedFromMailTransferAgent.Kind.GetName (), this.ReceivedFromMailTransferAgent.Value));
			}
		...
		#region method ParseHeaderRecipient
		...
		#region method CreateHeaderRecipient
		...
		private static IReadOnlyList<HeaderFieldBuilder> CreateHeaderRecipient (RecipientDeliveryStatus recipient)
		{
			...
			if (recipient.OriginalRecipient != null)
			{
				fields.Add (HeaderFieldBuilder.CreateAtomAndUnstructured (
					...
					recipient.OriginalRecipient.Kind.GetName (), recipient.OriginalRecipient.Value));
			}

			// Final-Recipient
			fields.Add (HeaderFieldBuilder.CreateAtomAndUnstructured (
				HeaderFieldName.FinalRecipient,
				recipient.FinalRecipient.Kind.GetName (), recipient.FinalRecipient.Value));
			...
			if (recipient.RemoteMailTransferAgent != null)
			{
				fields.Add (HeaderFieldBuilder.CreateAtomAndUnstructured (
					...
					recipient.RemoteMailTransferAgent.Kind.GetName (), recipient.RemoteMailTransferAgent.Value));
			}
			...
			if (recipient.DiagnosticCode != null)
			{
				fields.Add (HeaderFieldBuilder.CreateAtomAndUnstructured (
					...
					recipient.DiagnosticCode.Kind.GetName (), recipient.DiagnosticCode.Value));
			}
