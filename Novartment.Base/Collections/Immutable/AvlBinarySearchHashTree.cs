...
namespace Novartment.Base.Collections.Immutable
{
	...
	public static class AvlBinarySearchHashTree
	{
		...
		{
			return new _BinarySearchHashTreeEnumerator<T> (treeNode);
		}
		...
		#region class _BinarySearchHashTreeEnumerator<T>

		internal sealed class _BinarySearchHashTreeEnumerator<T> : IEnumerator<T>
		{
			...
			internal _BinarySearchHashTreeEnumerator (AvlBinarySearchHashTreeNode<T> treeNode)
			{
